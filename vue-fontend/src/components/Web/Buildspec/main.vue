...
<v-card height="700px" color="grey lighten-2">
    <v-stepper v-model="e1">
        <div class="v-background">
            <v-stepper-header>
                <v-stepper-step :complete="e1 > 1" step="1" color="red">Rods</v-stepper-step>

                <v-divider color="yellow"></v-divider>

                <v-stepper-step :complete="e1 > 2" step="2" color="red">Reels</v-stepper-step>

                <v-divider color="yellow"></v-divider>

                <v-stepper-step :complete="e1 > 3" step="3" color="red">Lines</v-stepper-step>

                <v-divider color="yellow"></v-divider>

                <v-stepper-step :complete="e1 > 4" step="4" color="red">Hooks</v-stepper-step>

                <v-divider color="yellow"></v-divider>

                <v-stepper-step :complete="e1 > 5" step="5" color="red">Specs</v-stepper-step>
            </v-stepper-header>
        </div>
        ...
        <v-stepper-items>
            ...
            <v-stepper-content step="5">
                ...
                <div class="text-xs-center ">
                    <v-btn round color="error">Build Spec</v-btn>
                </div>
            </v-stepper-content>
