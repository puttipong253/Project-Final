      ...
      <v-flex v-for="rod in rodList" :key="rod.id" md2>
        <v-hover>
          ...
          >
            ...
            <v-img :aspect-ratio="16/14" :src="rod.rod_image"></v-img>
            <v-card-text class="pt-4" style="position: relative;">
              <v-btn
                @click="storeRods(rod)"
                absolute
                color="orange"
                class="white--text z-index"
                fab
                small
                right
                top
              ...
              <div class="font-weight-light title text-xs-center mb-2">
                <h3
                  class="headline font-weight-light orange--text text-xs-center"
                >฿ {{rod.rod_price}}</h3>
              </div>
            </v-card-text>
          </v-card>
      ...
      <v-dialog v-model="dialog1" width="300px" persistent>
        <div class="text-xs-center">
          <v-card class="grey lighten-2">
            <v-card-title class="headline grey darken-3 white--text" primary-title>Description</v-card-title>
            <br />
